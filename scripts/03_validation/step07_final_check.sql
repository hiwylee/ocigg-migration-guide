...
-- [검증항목 SS-037~038] INVALID 객체 최종 확인
PROMPT
...
-- [검증항목 SS-006~009] UNUSABLE 인덱스 최종 확인
PROMPT
...
-- [검증항목 SS-001~005] 오브젝트 유형별 COUNT 소스/타겟 일치 확인
PROMPT
...
-- [검증항목 SS-036~037] 통계 없는 테이블/인덱스 최종 확인
PROMPT
PROMPT --- 통계 없는 테이블 ---
PROMPT [타겟] 기대값: 0
...
-- [검증항목 SS-019~023] Sequence GAP 최종 확인
PROMPT
